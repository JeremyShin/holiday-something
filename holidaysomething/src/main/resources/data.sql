...
INSERT INTO product_detail(id, description) VALUES (NULL, '<center><strong>

메이의 추천사 :
"매일을 깔끔하게 기록할 수 있는 메모지 3종입니다."

![001.png](/admin/product/image-files/b15819b6-e318-4d92-a255-aff0981b9273)

![002.png](/admin/product/image-files/1aa62442-dd81-4277-b67a-acb7d21450f1)
...
발랄한 색의 종이 메모지 3종입니다.
쉬는 날, 여행 갈 때, 매일 언제든 쓰고 있어요.
종이가 예뻐서 벽에 붙여도 귀엽더라구요.

![004.jpg](/admin/product/image-files/2ba6b6cb-8c5b-449b-980e-de50f26b7f2d)

_"3가지 색의 종이 메모지"_

![005.jpg](/admin/product/image-files/abaeb10a-1e33-4224-a803-fac793d9894e)

![006.jpg](/admin/product/image-files/af73d84d-e5d5-41db-b6ce-e165daca01fd)

_"종이 3장의 색이 모두 명확하게 달라서
필요한 종이를 쉽게 고를 수 있어요."_

![007.jpg](/admin/product/image-files/c691fd9b-1cbf-4ecb-90e8-27f297981813)

_"쉬는 날, 여행갈 때, 매일 언제든 쓰기 좋아요."_
...
![020.gif](/admin/product/image-files/87e14d59-cbcc-46ea-accd-7f008c6758b2)
...
홀리데이썸띵의 작은 선물입니다 :)
 ...
 INSERT INTO product (id,code,manufacturer,name,optional_price_text,original_price,quantity,selling_price,shipping_price,product_category_id,product_detail_id,manufacturing_price, selling_quantity,safe_quantity,mileage,display,manufacture_date,reg_date,release_date)
VALUES (46,'2019020701','홀리데이','홀리데이메모패드',NULL,5500,30,3000,3000,11,46,1000, 0, 10, 30, true,  '2018-12-24 12:22:05',  '2018-12-25 09:22:05',  '2018-12-25 10:22:05');

INSERT INTO product_image(id, category, file_type, original_file_name, path, reg_date, size, stored_file_name, update_date, product_id)
VALUES (null, 3, 'image/png', '001.png', 'https://holidaysomething-webservice-s3.s3.ap-northeast-2.amazonaws.com/static/images/', '2019-02-07 12:52:08', 2976239.0, 'b15819b6-e318-4d92-a255-aff0981b9273', '2019-02-07 12:52:08', null);
INSERT INTO product_image(id, category, file_type, original_file_name, path, reg_date, size, stored_file_name, update_date, product_id)
VALUES (null, 3, 'image/png', '002.png', 'https://holidaysomething-webservice-s3.s3.ap-northeast-2.amazonaws.com/static/images/', '2019-02-07 12:52:08', 61121.0, '1aa62442-dd81-4277-b67a-acb7d21450f1', '2019-02-07 12:52:08', null);
INSERT INTO product_image(id, category, file_type, original_file_name, path, reg_date, size, stored_file_name, update_date, product_id)
VALUES (null, 3, 'image/jpeg', '004.jpg', 'https://holidaysomething-webservice-s3.s3.ap-northeast-2.amazonaws.com/static/images/', '2019-02-07 12:52:08', 864623.0, '2ba6b6cb-8c5b-449b-980e-de50f26b7f2d', '2019-02-07 12:52:08', null);
INSERT INTO product_image(id, category, file_type, original_file_name, path, reg_date, size, stored_file_name, update_date, product_id)
VALUES (null, 3, 'image/jpeg', '005.jpg', 'https://holidaysomething-webservice-s3.s3.ap-northeast-2.amazonaws.com/static/images/', '2019-02-07 12:52:08', 787637.0, 'abaeb10a-1e33-4224-a803-fac793d9894e', '2019-02-07 12:52:08', null);
INSERT INTO product_image(id, category, file_type, original_file_name, path, reg_date, size, stored_file_name, update_date, product_id)
VALUES (null, 3, 'image/jpeg', '006.jpg', 'https://holidaysomething-webservice-s3.s3.ap-northeast-2.amazonaws.com/static/images/', '2019-02-07 12:52:08', 676785.0, 'af73d84d-e5d5-41db-b6ce-e165daca01fd', '2019-02-07 12:52:08', null);
INSERT INTO product_image(id, category, file_type, original_file_name, path, reg_date, size, stored_file_name, update_date, product_id)
VALUES (null, 3, 'image/jpeg', '007.jpg', 'https://holidaysomething-webservice-s3.s3.ap-northeast-2.amazonaws.com/static/images/', '2019-02-07 12:52:08', 766985.0, 'c691fd9b-1cbf-4ecb-90e8-27f297981813', '2019-02-07 12:52:08', null);
INSERT INTO product_image(id, category, file_type, original_file_name, path, reg_date, size, stored_file_name, update_date, product_id)
VALUES (null, 3, 'image/gif', '020.gif', 'https://holidaysomething-webservice-s3.s3.ap-northeast-2.amazonaws.com/static/images/', '2019-02-07 12:52:08', 1135222.0, '87e14d59-cbcc-46ea-accd-7f008c6758b2', '2019-02-07 12:52:08', null);
INSERT INTO product_image(id, category, file_type, original_file_name, path, reg_date, size, stored_file_name, update_date, product_id)
